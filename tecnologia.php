...
<div class="row">
	...
	<?php
	try {
		$query = $conn->prepare("SELECT ID, NOMBRE, DESCRIPCION, PRECIO, IMAGEN FROM productos WHERE CATEGORIA = 'tecnologia'");
		$query->execute(array());
	...
	foreach ($result as $key => $producto) { ?>
		<div class="col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 " margin botton="20px">
